...
const mediaMenu = [
  ...
  },
  {
    key: '3',
    label: (
      <a target="_blank" rel="noreferrer" href="https://t.me/Fairyproof_tech">
        <Space>
          <span
            style={{
              lineHeight: '20px',
      ...
      <Menu
        items={[
          getItem(
            ...
            null,
            [
              getItem(<a href="/products/audit-intro">Security Audit</a>, '01'),
              getItem(<a href="/products/tools">Security Tools</a>, '02'),
              getItem(
                <a href="/products/uservice">General Data Queries</a>,
                '03'
              ),
              getItem(
                <a href="/products/audit">Verify Audited Projects</a>,
                '04'
              )
            ],
            'group'
        ...
        items={[
          getItem(
            ...
            [
              ...
              getItem(<a href="/company/careers">Careers</a>, '12'),
              getItem(<a href="/company/disclaimer">Disclaimer</a>, '13')
            ],
            'group'
          )
        ]}
