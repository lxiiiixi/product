...
import { LinkedinOutlined, TwitterOutlined, MediumOutlined } from "@ant-design/icons";

import FpLogo from "@/assets/fairyproof/fp_logo.png";
import SubstackLogo from "@/assets/logo/substack_logo.svg";
import TelegramLogo from "@/assets/logo/telegram_logo.svg";
    ...
    const FooterLinks = ({
        ...
        return (
            <a
                ...
                href={href}
            >
                <span className="rounded-full text-white bg-black text-sm w-5 h-5 flex-center">
                    {icon}
                </span>
